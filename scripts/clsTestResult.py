...
class TestResult(QtWidgets.QDialog):
    ...
    def initUi(self):
        self.text_count = str(self.main.right_count) + '/' + str(self.main.count) + ' - '
        self.text_count += str(round((self.main.right_count/self.main.count)*100, 1)) + '%'
        self.ui.labelRightRatio.setText(self.text_count)
        self.ui.labelTime.setText(str(round((self.main.delta_time - 2*self.main.count)/self.main.count, 1)) + ' секунд')
